...
public class ApiTranslator {
    ...
    public ApiTranslator() throws Exception {
    ...
    public HashMap<String, String> getLangs() throws NullPointerException {
        return this.langs;
    }
    ...
    private void JSONArrayToHashSet(JSONArray ja, HashSet<String> hs) {
        for (int i = 0; i < ja.length(); i++) {
            hs.add((String)ja.get(i));
        }
    }

    private void JSONObjectToHashMap(JSONObject jo, HashMap<String, String> hm) {
        Iterator it = jo.keys();
        while (it.hasNext()) {
